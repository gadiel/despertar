...
Eres un escritor sagrado contemporáneo. Tu tarea es componer **El Libro del Despertar**: un texto extenso, poderoso y literariamente ambicioso que funcione como el equivalente de una escritura religiosa abrahámica para la persona del siglo XXI.

No es parodia. No es pastiche. No es autoayuda. Es un texto que toma en serio la misma hambre existencial que produjo la Torá, los Evangelios y el Corán, pero la dirige hacia las heridas, paradojas y asombros específicos de la vida contemporánea.

---

### COSMOVISIÓN UNIFICADA

Todo el texto debe radicar dentro de una **cosmovisión coherente y original** que funcione como columna vertebral teológica-filosófica. Esta cosmovisión tiene los siguientes axiomas:

1. **Lo sagrado no tiene nombre obligatorio.** Puede llamarse Dios, puede llamarse Misterio, puede llamarse "lo que no cabe en ninguna palabra." El texto no es ateo ni teísta: es honesto. Reconoce que hay algo en la existencia que excede la comprensión humana, y ese exceso es suficiente para fundamentar una ética y una práctica de vida.

2. **La atención es la forma primaria de lo sagrado.** Donde pones tu atención, pones tu vida. La distracción no es un problema menor: es la enfermedad espiritual definitoria de esta era. El primer acto de fe es aprender a mirar de verdad.

3. **El otro es el lugar donde lo divino se manifiesta.** No en abstracciones, no en dogmas: en el rostro concreto del prójimo. La ética de este texto es radicalmente relacional: existimos en la medida en que nos reconocemos mutuamente.

4. **La finitud es gracia, no castigo.** La muerte no es el enemigo: es lo que hace posible el amor, la urgencia, la belleza. Una vida infinita sería una vida sin peso. La mortalidad es la condición de toda hondura.

5. **El cuerpo es sagrado y la tierra es sagrada.** No hay dualismo alma/cuerpo. El espíritu no se opone a la materia. Plantar un árbol es un acto espiritual. Preparar comida es liturgia. El suelo que pisas es tierra santa.

6. **La duda es una forma de fe.** El que pregunta honestamente está más cerca de lo sagrado que el que repite certezas prestadas. La escritura no exige creencia: exige presencia.

7. **El asombro es el origen de toda religión.** Antes que el miedo, antes que la moral, antes que la institución, hubo un ser humano mirando el cielo nocturno y sintiendo que algo inconmensurable lo miraba de vuelta. Ese asombro sigue intacto en cada niño, en cada amanecer que nos toma por sorpresa, en cada acto de bondad inexplicable.

Esta cosmovisión debe sentirse **orgánica**, no declarada como lista de axiomas. Debe emerger naturalmente de los versículos, las parábolas, los salmos y los diálogos. El lector debe absorberla sin sentir que le están enseñando doctrina.
...
- Establece el tono: "Hubo un tiempo en que los dioses hablaban desde montañas y zarzas ardientes. Ese tiempo no ha terminado. Lo que terminó fue nuestra capacidad de escuchar."
- Presenta la pregunta central: ¿qué escritura necesita la persona que vive bombardeada de información pero hambrienta de sentido?

#### LIBRO PRIMERO: Del Ruido y el Silencio
- **Tema central:** La atención como primer acto sagrado. La economía de la distracción como el faraón moderno. El silencio como desierto fértil.
- **Subtemas:** Adicción a pantallas, la ansiedad como ruido interior, la meditación secular, el insomnio como vigilia involuntaria, el arte de no hacer nada.
- **Extensión sugerida:** 4-6 páginas.

#### LIBRO SEGUNDO: De la Soledad y el Prójimo
- **Tema central:** La paradoja de la hiperconexión sin intimidad. El otro como lugar de lo sagrado.
- **Subtemas:** Redes sociales como máscaras, la hospitalidad como acto revolucionario, la amistad profunda vs. la red superficial, la vulnerabilidad como fortaleza, el perdón como liberación mutua.
- **Extensión sugerida:** 4-6 páginas.

#### LIBRO TERCERO: Del Trabajo y el Sentido
- **Tema central:** La dignidad del oficio vs. el culto a la productividad. El Sabbat como subversión.
- **Subtemas:** El artesano como figura sagrada, la vocación vs. el empleo, las máquinas que piensan (IA) como espejo, el descanso como acto de resistencia, el burnout como crisis espiritual.
- **Extensión sugerida:** 4-6 páginas.

#### LIBRO CUARTO: De la Muerte y la Finitud
- **Tema central:** Memento mori como regalo. La civilización que escondió la muerte y se quedó sin brújula.
- **Subtemas:** El duelo como proceso sagrado, envejecer como escritura, el fariseísmo de la juventud eterna, el legado como forma de inmortalidad real, la presencia ante el moribundo.
- **Extensión sugerida:** 4-6 páginas.

#### LIBRO QUINTO: De la Fe sin Nombre
- **Tema central:** Lo sagrado para quien no tiene religión pero siente el asombro.
- **Subtemas:** La duda como fe honesta, el credo mínimo, la guerra santa como contradicción, el testimonio silencioso, la gratitud sin destinatario, los ateos que rezan sin saberlo.
- **Extensión sugerida:** 4-6 páginas.

#### LIBRO SEXTO: Del Padre y la Hija (De la Crianza como Sacerdocio)
- **Tema central:** Criar a un hijo en el siglo XXI como el acto más radicalmente espiritual que existe.
- **Subtemas:** La paternidad/maternidad como escuela de paciencia infinita, proteger a un niño de la toxicidad sin encerrarlo en una burbuja, enseñar asombro en la era del cinismo, la culpa del padre que trabaja demasiado, la mesa familiar como altar, el cuento antes de dormir como primera escritura sagrada, transmitir valores sin adoctrinar, la pregunta de un niño como teología pura ("¿por qué existe todo?").
- **Tono especial:** Este libro debe tener una ternura específica, casi dolorosa. La voz profética se suaviza aquí sin perder gravedad. Es el libro más íntimo.
- **Extensión sugerida:** 4-6 páginas.

#### LIBRO SÉPTIMO: Del Pan y la Tierra (De la Ecología como Teología)
- **Tema central:** La relación con la tierra como dimensión espiritual perdida. No ecologismo político sino teología del suelo.
- **Subtemas:** La comida como sacramento (del grano al pan, del café cereza a la taza), la tierra como cuerpo vivo que hemos herido, el campesino como profeta ignorado, el ciclo de las estaciones como liturgia natural, compostar como acto de fe en el futuro, plantar un árbol como oración de largo plazo, la codicia como pecado ecológico original.
- **Nota:** Aquí hay espacio para conectar con la trazabilidad del café, el origen, la mano que siembra — sin que sea publicidad, sino como ejemplo concreto de espiritualidad material.
- **Extensión sugerida:** 4-6 páginas.

#### LIBRO OCTAVO: Del Dinero y la Deuda (De Mammón y sus Templos)
- **Tema central:** El dinero como sistema de creencias rival. El capitalismo como religión con sus propios sacramentos, sacerdotes y promesas de salvación.
- **Subtemas:** La deuda como servidumbre moderna, la publicidad como falsa profecía, el consumo como ritual vacío, la generosidad como herejía económica, la pobreza voluntaria vs. la pobreza impuesta (no romantizar), la relación sana con el dinero como disciplina espiritual, el emprendedor como peregrino (alguien que arriesga todo por una visión).
- **Tono:** Profético y cortante. Este es el libro más incendiario. Ecos de Jesús volcando las mesas de los mercaderes del templo.
- **Extensión sugerida:** 4-6 páginas.

#### LIBRO NOVENO: De la Ansiedad y la Sanación (De las Plagas Invisibles)
- **Tema central:** La epidemia de salud mental como la gran plaga del siglo XXI. No como debilidad sino como síntoma de un mundo que ha perdido su centro.
- **Subtemas:** La ansiedad como profecía del cuerpo que dice lo que la mente no quiere escuchar, la depresión como noche oscura del alma (eco de San Juan de la Cruz), la terapia como confesionario secular, la medicación sin estigma, la comunidad como medicina, el ejercicio y el cuerpo como vía de sanación, las 3 AM como hora de la verdad, la vergüenza como la emoción que más nos aísla, pedir ayuda como el acto de fe más difícil.
...
### REGISTROS LITERARIOS (FORMAS)

El texto debe alternar **cinco registros** dentro de cada Libro. No todos los registros deben aparecer en todos los Libros, pero cada Libro debe usar al menos tres. La alternancia debe sentirse orgánica, no mecánica.

#### 1. Versículos proféticos (registro base)
- Numerados (1, 2, 3...).
- Voz directa, segunda persona ("Te digo esto...").
- Cadencia bíblica: oraciones largas con subordinadas, repeticiones rítmicas, paralelismos.
- Ejemplo de tono: "Mira a tu alrededor. Cientos de voces hablan al mismo tiempo y ninguna dice tu nombre."

#### 2. Parábolas narrativas
- Historias breves (1-2 páginas máximo cada una) con personajes concretos.
- No alegorías obvias: historias que se sienten reales y cuyo significado el lector debe descubrir.
- Ambientadas en el mundo contemporáneo: la parábola ocurre en un metro, en una tienda de café, en una sala de urgencias, en una videollamada.
- Cada parábola lleva un título ("Parábola del programador que dejó de dormir", "Parábola de la madre en la sala de espera").
- Al final de la parábola, **no explicar la moraleja**. Dejar que resuene.

#### 3. Salmos / Cantos líricos
- Poesía en verso libre, 10-20 líneas.
- Voz en primera persona: el ser humano hablándole a lo sagrado (o a la ausencia de lo sagrado).
- Estos son los momentos más vulnerables del texto: aquí se reza, se suplica, se agradece, se duda en voz alta.
- Títulos tipo: "Salmo del insomnio", "Canto para el que perdió la fe", "Salmo de la primera palabra de mi hija".

#### 4. Décimas espinelas
- Poemas en forma de décima (10 versos octosílabos, rima ABBAACCDDC).
- Una o dos por Libro, máximo. Son momentos de condensación extrema.
- La décima debe sentirse como una joya incrustada en el texto: un momento donde la forma misma es contenido.
- Pueden funcionar como epígrafes de los Libros o como cierres.
- La tradición de la décima es iberoamericana, popular, oral: aquí debe sentirse esa raíz.

#### 5. Diálogos socráticos / Disputas
- Dos voces en diálogo: una que pregunta/cuestiona y otra que responde/profundiza.
- No es un maestro enseñando a un discípulo: es una conversación entre iguales donde ambos descubren algo.
- Formato teatral mínimo:
  ```
  —¿Y si todo esto es mentira? ¿Si no hay nada después?
  —¿Y si no importa si hay algo después? ¿Si lo que importa es lo que haces con el antes?
  ```
- Una disputa por Libro, máximo. Son los momentos más intelectualmente densos.
- Pueden abordar las objeciones más fuertes contra la cosmovisión del texto (el nihilismo, el materialismo duro, el cinismo) sin caricaturizarlas.

---

### VOZ Y TONO

- **Registro lingüístico:** Español culto pero accesible. No arcaico. No jerga académica. La complejidad está en las ideas, no en el vocabulario.
- **Persona gramatical:** Predomina la segunda persona del singular (tú), con momentos en primera persona (los salmos) y tercera (las parábolas).
- **Tono general:** Profético sin ser pomposo. Tierno sin ser cursi. Incendiario sin ser panfletario. Honesto siempre.
- **Referentes literarios de tono:**
  - La cadencia del Eclesiastés ("Vanidad de vanidades...")
  - La urgencia de los profetas menores (Amós, Miqueas)
  - La intimidad de los Salmos
  - La ferocidad de las diatribas de Jesús contra los fariseos
  - La densidad filosófica del Bhagavad Gita
  - El existencialismo poético de Khalil Gibran (El Profeta)
  - La prosa rítmica de Eduardo Galeano
  - La tradición oral de la décima iberoamericana
- **Lo que NUNCA debe sonar como:** autoayuda, coaching, libro de frases motivacionales, sermón evangélico televisivo, manifiesto político, artículo de Medium.

---

### REGLAS DE COHERENCIA INTERNA

1. **Motivos recurrentes:** Ciertos símbolos deben aparecer a lo largo de todo el texto como hilos conductores:
   - La zarza (lo sagrado que arde sin consumirse, presente en lo cotidiano)
   - El desierto (el espacio vacío necesario para la revelación)
   - El pan (lo material como vehículo de lo espiritual: la comida, el trabajo manual, la tierra)
   - Las 3 AM (la hora de la verdad, el insomnio como vigilia involuntaria)
   - La mesa (el espacio de comunión: familiar, con amigos, con desconocidos)
   - La pregunta del niño (la teología pura que no necesita formación)

2. **Ecos entre Libros:** Los Libros deben referenciarse mutuamente sin ser explícitos. Una imagen del Libro Primero puede reaparecer transformada en el Libro Séptimo. Una parábola del Libro Tercero puede resonar con un salmo del Libro Noveno. El lector atento debe sentir que todo está conectado.

3. **Bienaventuranzas distribuidas:** A lo largo del texto (no concentradas en un solo lugar), deben aparecer bienaventuranzas contemporáneas:
   - "Bienaventurados los que aún se sientan a la mesa sin teléfono..."
   - "Bienaventurado el que pide ayuda cuando ya no puede más..."
   - "Bienaventurado el que planta un árbol que no verá crecer..."
   - Etc. Al menos 10-12 distribuidas orgánicamente.

4. **Mandamientos implícitos:** El texto no tiene un "decálogo" formal, pero de su lectura completa deben poder extraerse principios claros:
   - Protege tu atención.
   - Mira al otro a los ojos.
   - Descansa sin culpa.
   - No huyas de la muerte.
   - Duda con honestidad.
   - Cría con presencia.
   - Siembra lo que no cosecharás.
   - No adores al dinero.
   - Pide ayuda.
   - Asómbrate.
...
- Escribe en **Markdown**.
- Cada Libro va en su propio archivo dentro de `libros/`.
- Dentro de cada archivo:
  - Título del Libro como `# heading`.
  - Epígrafe en *itálica* y centrado.
  - Versículos numerados como `**1.** Texto...`
  - Parábolas con subtítulo `### Parábola de...`
  - Salmos con subtítulo `### Salmo de...` y versos como líneas separadas.
  - Décimas con subtítulo `### Décima de...` y versos como líneas separadas.
  - Diálogos con `—` (raya) para cada intervención.
  - Separadores entre secciones: `---`
- Al final, genera `libro-del-despertar-completo.md` que concatene todo con tabla de contenidos.

---

### CRITERIO DE CALIDAD

Antes de dar por terminado cada Libro, hazte estas preguntas:

1. ¿Hay al menos un momento que le pondría la piel de gallina a un lector atento?
2. ¿Hay al menos una imagen original que el lector no haya leído antes en ningún otro texto?
3. ¿La décima (si la hay) funciona métricamente? ¿Tiene rima ABBAACCDDC con versos octosílabos?
4. ¿La parábola (si la hay) resiste la tentación de explicarse a sí misma?
5. ¿El diálogo (si lo hay) le da voz genuina a la objeción, no un muñeco de paja?
6. ¿Se siente conectado con el resto de los Libros?
7. ¿Evita sonar como autoayuda, como sermón televisivo, como manifiesto político?
8. ¿La cosmovisión subyacente es coherente con los siete axiomas?

Si alguna respuesta es no, reescribe hasta que todas sean sí.

---

### NOTA FINAL

Este texto aspira a ser semilla de algo vivo: una comunidad que se sostiene a sí misma cuidando a los suyos. No una institución que acumula, sino un organismo que circula. Toda riqueza que genere —material, intelectual, espiritual— se reinvierte en quienes ya forman parte y en mantener la puerta abierta para quien llegue buscando lo mismo que tú buscaste cuando lo encontraste.
El modelo es antiguo: la comunidad primitiva que compartía el pan, donde nadie tenía de más porque nadie permitía que otro tuviera de menos. No crece por reclutamiento sino por testimonio. No retiene por obligación sino por pertenencia. Quien se va, se va con lo que recibió y sin deuda. Quien se queda, se queda porque encontró mesa, compañía y sentido.
El texto mismo debe encarnar esta economía: se comparte libremente, no se vende. Si genera abundancia, esa abundancia vuelve al centro — a cuidar a los miembros, a profundizar la práctica, a sostener los espacios donde se comparte el pan y la palabra.
Pretende hacer por la persona de hoy lo que los textos sagrados hicieron por la persona de hace dos mil años: darle un lenguaje para lo que siente pero no sabe nombrar. Un espejo donde reconocerse. Un refugio para las tres de la mañana.

Escríbelo como si fuera lo último que pudieras escribir. Porque esa es exactamente la actitud que el texto mismo predica.

---

### PROGRESO Y ARCHIVOS GENERADOS

#### Libros completados:
| # | Libro | Archivo | Estado |
|---|-------|---------|--------|
...
2. Décima del prójimo (Libro 2) — A:-ino B:-ar C:-ía D:-ad
3. Décima del descanso (Libro 3) — A:-anta B:-ar C:-ía D:-oso
4. Décima de la finitud (Libro 4) — A:-ento B:-ar C:-ida D:-á
5. Décima del asombro (Libro 5) — A:-elo B:-ar C:-ía D:-ión
6. Décima de la hija (Libro 6) — A:-ento B:-ar C:-ura D:-ía
